...
function show_button(boton){
	...
	aboutDiv.style.backgroundColor = " #976FA7";
	aboutDiv.style.boxShadow = "none";
	
	knowDiv.style.backgroundColor = " #976FA7";
	knowDiv.style.boxShadow = "none";
	
	expDiv.style.backgroundColor = "#976FA7";
